                                        ...
                                        <button type="button" class="btn btn-fefault cart">
                                            ...
                                            @if ($availability == false)
                                                <div style="cursor: not-allowed;">
                                                    <a href="{{ route('public.cart.add', $book->id) }}" style="pointer-events: none;" class="none-button"><i class="fas fa-ban"></i> Indisponible</a>
                                                </div>
                                            @else
                                                ...
                                                <div class="col-sm-4"><div class="product-image-wrapper">
                                                    <div class="single-products">
                                                        <div class="productinfo text-center">
                                                            ...
                                                            @if ($availability == false)
                                                                <div style="cursor: not-allowed;">
                                                                    <a href="{{ route('public.cart.add', $single_book->id) }}" style="pointer-events: none;" class="btn btn-default add-to-cart"><i class="fas fa-ban"></i> Indisponible</a>
                                                                </div>
                                                            @else
